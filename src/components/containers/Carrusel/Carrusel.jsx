    ...
    <section className="carrusel" key={title}>
        { (isCarrusel) ?
            ...
            <ul className='glide__slides'>
                ...
                hasArrows
                arrows={{
                    prev: refBtnLeftGlide.current,
                    next: refBtnRightGlide.current
                }}
                slidesToShow={configSlider.settings.slidesToShow}
                draggable={configSlider.settings.draggable}
                scrollToSlide={configSlider.settings.scrollToSlide}
                duration={configSlider.settings.duration}
                responsive={configSlider.responsive}
                onAnimated={e =>{
            ...
            <div className="glide__arrows">
                <button className="glide__arrow control" ref={refBtnLeftGlide}>
                ...
                <button className="glide__arrow control" ref={refBtnRightGlide}>
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
